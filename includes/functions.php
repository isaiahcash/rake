...
function start_page()
{
    ...
    <head>
        ...
        <link rel="stylesheet" href="/rake/includes/css/bootstrap.css">
        <link rel="stylesheet" href="/rake/includes/source/datatables/datatables.js">
        <link rel="stylesheet" href="/rake/includes/source/datatables/DataTables-1.10.18/css/dataTables.bootstrap4.css">
        <link rel="stylesheet" href="/rake/includes/css/font-awesome.css">

        <link rel="stylesheet" href="/rake/includes/css/style.css">
    </head>
    <body>
...
{
    ?>
    <script src="/rake/includes/js/jquery-3.js"></script>
    <script src="/rake/includes/js/bootstrap.js"></script>
    <script src="/rake/includes/js/popper.js"></script>


    <script src="/rake/includes/source/datatables/datatables.js"></script>
    <script src="/rake/includes/source/datatables/DataTables-1.10.18/js/dataTables.bootstrap4.js"></script>

    <script src="/rake/includes/js/scripts.js"></script>
    <?php
}
...
{
    ?>
    <button onclick="topFunction()" id="top_button" title="Go to top"> <i class="fa fa-arrow-up"></i></button>
    </body>
    </html>
    <?php
}
